...
export default function HomePage() {
  const featuredProperties = dummyProperties
    .filter((p) => p.featured)
    .slice(0, 3);
          ...
          <div className="container">
            <div className="mx-auto max-w-3xl text-center space-y-8">
              ...
              <p className="text-lg md:text-xl text-muted-foreground text-balance">
                Discover, filter, and interact with property listings across
                Kenyan cities. Your dream home is just a search away.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
                ...
                <Link
                  href="/search?location=Kilimani"
                  className="hover:text-primary transition-colors"
                >
                  Kilimani
                </Link>
                <Link
                  href="/search?location=Westlands"
                  className="hover:text-primary transition-colors"
                >
                  Westlands
                </Link>
                <Link
                  href="/search?location=Karen"
                  className="hover:text-primary transition-colors"
                >
                  Karen
                </Link>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-muted-foreground">
                  Explore our most popular listings
                </p>
              </div>
          ...
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                We provide a comprehensive platform for all your real estate
                needs
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Browse thousands of properties across Kenya, from apartments
                    to luxury villas
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    All properties are verified by our team to ensure accuracy
                    and prevent fraud
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Connect with professional agents who understand the local
                    market
                  </p>
                </CardContent>
              </Card>
